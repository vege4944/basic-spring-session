...
public class BoardController {
    ...
    public ResponseEntity<BoardUpdateTitleResponseDto> updateBoardTitle (
        ...
        return ResponseEntity.ok(boardService.updateTitle(boardId, boardUpdateTitleRequestDto));
    }
    ...
    public ResponseEntity<BoardUpdateContentsResponseDto> updateBoardContents (
        ...
        return ResponseEntity.ok(boardService.updateContents(boardId, boardUpdateContentsRequestDto));
    }
