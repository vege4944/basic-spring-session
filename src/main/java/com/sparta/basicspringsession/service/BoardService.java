...
public class BoardService {
    ...
    public BoardUpdateTitleResponseDto updateBoardTitle (
        ...
        Board board = boardRepository.findById(boardId).orElseThrow(()-> new NullPointerException("보드없음"));
    ...
    public BoardUpdateContentsResponseDto updateBoardContents (
        ...
        Board board = boardRepository.findById(boardId).orElseThrow(()-> new NullPointerException("보드없다"));
